...
const Showcase = () => {
    ...
    useGSAP(() => {
        ...
        timeline
            ...
            .fromTo('.content', { opacity: 0, y: 20 }, { opacity: 1, y: 0, ease: 'power1.in' });
    }, [])
                ...
                <div className="wrapper">
                    <div className="lg:max-w-md">
                        ...
                        <div className="space-y-5 mt-7 pe-10">
                            ...
                            <p>
                                M4 powers iPad Pro. It drives Apple Intelligence on iPad Pro, so you can write, create, and accomplish more with ease. All in a design that’s unbelievably thin, light, and powerful.
                            </p>
                            <p>
